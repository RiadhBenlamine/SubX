...
from core.ui.console import console, info, warn, success, error
...
class DbCommand(Command):
    ...
    def callback(
        ...
        self.run_async(self._db(domain, web, filter_plugin, new_since, delete, output_n, output_x, raw_query))
    ...
    async def _db(
        ...
        await self._db_query(service, domain, web, filter_plugin, new_since, output_n, output_x)
